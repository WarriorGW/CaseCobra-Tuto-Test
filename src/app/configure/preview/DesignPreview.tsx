  ...
  const { mutate: createPaymentSession } = useMutation({
    ...
    onError: () => {
      toast({
        ...
        description: "There was an error on our endd. Please try again.",
        variant: "destructive",
      })
    },
  })
    ...
    <>
      ...
      <div className="mt-20 grid grid-cols-1 text-sm sm:grid-cols-12 sm: grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
        <div className="sm:col-span-4 md:col-span-3 md:row-span-2 md:row-end-2">
          <Phone
            className={cn(`bg-${tw}`)}
            imgSrc={configuration.cropImgUrl!}
          />
        </div>
        ...
        <div className="sm:col-span-12 md:col-span-9 text-base">
          <div className="grid grid-cols-1 gap-y-8 border-b border-r-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:gap-y-10">
            <div>
              <p className="font-medium text-zinc-950">Highlights</p>
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                <li>Wireless charging comptaible</li>
            ...
            <div>
              ...
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                ...
                <li>Scratch and fingerprnt resistant coating</li>
              </ol>
            </div>
          </div>
